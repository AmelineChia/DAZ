<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HousekeepingManagementDelete.aspx.cs" Inherits="Hotel_Management_System_Software.HousekeepingManagementDelete" %>
...
<body>
    ...
    <div style="background-image:url('/Image/Background1.jpg'); margin-left:auto; text-align:center; height: 1620px;">
     <br />
        ...
        <br />
        <br />
        <div style="float:left; width:311px; height:25px; margin-left: 740px">
        ...
        <br />
        <br />
        <div style="float:left; width: 257px; height: 25px; margin-left: 445px">
        ...
        <br /> 
        <br />  
        <div style="float:left; width: 651px; height: 25px; margin-left: 550px">
            <asp:Button ID="Button1" runat="server" Text="Delete" Font-Size="Large" Font-Bold="true" BorderStyle="Solid" Width="450px" Height="38px" />
        </div>
        <br />
        <br />
        <br /> 
