<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HousekeepingManagementUpdate.aspx.cs" Inherits="Hotel_Management_System_Software.HousekeepingManagementUpdate" %>
    ...
    <div style="background-image:url('/Image/Background1.jpg'); margin-left:auto; text-align:center; height: 1620px;">
     <br />
        ...
        <div style="float:left; width: 651px; height: 25px; margin-left: 560px">
            <asp:Button ID="Button1" runat="server" Text="Update" Font-Size="Large" Font-Bold="true" BorderStyle="Solid" Width="450px" Height="38px" />
        </div>
        <br />
        <br />
        <br /> 
